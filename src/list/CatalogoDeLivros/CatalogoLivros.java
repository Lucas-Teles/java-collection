...
public class CatalogoLivros {
    ...
    public static void main(String[] args) {
        ...
        catalogoLivros.adicionarLivro("Livro 3", "Autor 4", 1996);
        catalogoLivros.adicionarLivro("Livro 4", "Autor 1", 1986);

        System.out.println(catalogoLivros.pesquisarPorAutor("Autor 1"));
        System.out.println(catalogoLivros.pesquisarPorIntervaloAnos(1992, 2005));
